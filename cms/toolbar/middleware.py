...
class ToolbarMiddleware(object):
    ...
    """
    def __init__(self, show_toolbar_func=show_toolbar,
                 get_toolbar_context_func=get_toolbar_context):
        self.show_toolbar = show_toolbar_func
        self.get_toolbar_context = get_toolbar_context_func
